...
::: {.notes}
Обратный слэш между двумя фигурными скобками – это такой предохранитель от поиска файла `_data.qmd`, которого у меня нет. Синтаксиси Quarto работает на разных уровнях, в том числе внутри блоков кода.
