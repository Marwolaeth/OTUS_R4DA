...
::: {.notes}
Из преимуществ модульного дизайна для нас самым важным, наверное, является четвертое. Ссылаться на один готовый документ в нескольких местах гораздо проще и безопаснее, чем копировать и вставлять.
...
::: {.notes}
Если мы запрашиваем использование библиотек Латех в заголовке документа или во внешней инструкции, Quarto (как и Rmarkdown) ищут и загружают их для нас.
