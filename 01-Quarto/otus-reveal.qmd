...
:::::: {.column}
![](slides/quarto-hamlet-1.jpeg){fig-alt="Старая книга «Гамлет» in quarto" fig-title="Старая книга «Гамлет» in quarto" height="13em"}
...
::: {layout-ncol=2}
![](slides/quarto){width=125 alt="Логотип Quarto" title="Логотип Quarto"}

![](slides/posit2){width=125 alt="Логотип Posit"  title="Логотип Posit"}
:::
::::::
:::
...
## Общий алгоритм проектов Quarto {.smaller background-image="slides/slide.jpg" background-size="contain"}
...
## Как работает Quarto {.smaller background-image="slides/slide.jpg" background-size="contain"}
...
Конечно, для генерации документов с кодом нам потребуется соответственно R для «Нитр» и Python для Jupyter, и Julia для самой себя. Но если у вас уже есть документ в формате markdown (напомню, это статичный документ: на втором шаге Нитр или Юпитер жестко кодируют в markdown вывод, сгкенерированный кодом: строят markdown-таблицу, если это таблица или датафрейм, если это диаграмма — сохраняют ее как изображение в отдельный файл и вставляют ссылку) — так вот, если у вас уже есть статичный документ, то для его верстки в любой формат вам понадобится только Quarto.
...
## Пример настройки: HTML {.smaller background-image="slides/slide.jpg" background-size="contain"}
...
## Пример настройки: PDF {.smaller background-image="slides/slide.jpg" background-size="contain"}
...
# Кастомизация проекта: элементы Quarto {background-image="slides/section.jpg" background-size="contain"}
...
::: {.notes}
В качестве примера многострочного текста в опциях я решил привести реальный заголовок из чужого проекта. Собственно, мы уже сталкивались с многострочным текстом в качестве значения yaml-опции мы уже сталкивались выше. Да, в большинстве случаев такие опции используются для передачи TeX-скриптов. В этом примере это javascript, но если присмотреться, речь все равно идет о TeX. Капризный TeX, который часто нужно настраивать.
:::
...
::: {#fig-images layout="[[20,20], [40]]" style="font-size:0.5em;"}
![Первая картинка](slides/quarto){#fig-01 width=20}

![Вторая картинка](slides/quarto){#fig-02 width=20}

![Картинка во втором ряду](slides/quarto){#fig-long width=40}
...
## Интерактивные элементы {.smaller .scrollable background-image="slides/slide.jpg" background-size="contain"}
...
## Макеты страниц {.smaller .scrollable background-image="slides/slide.jpg" background-size="contain"}
...
## Макеты для интерактивного взаимодействия {.smaller .scrollable background-image="slides/slide.jpg" background-size="contain"}
...
# Комплексные публикации {background-image="slides/section.jpg" background-size="contain"}

## Сайты, блоги, книги {.smaller background-image="slides/slide.jpg" background-size="contain"}
...
## Создание сайта в Quarto – Заготовка {.smaller background-image="slides/slide.jpg" background-size="contain"}
...
::: {.column}
![](slides/website-01-project.jpg){fig-height=100}

Выбираем Quarto…
:::
::: {.column}
::::: {.fragment}
![](slides/website-02-files.jpg){fig-height=100}
...
## Создание сайта в Quarto – Метаданные {.smaller background-image="slides/slide.jpg" background-size="contain"}
...
## Создание сайта в Quarto – Навигация {.smaller background-image="slides/slide.jpg" background-size="contain"}
...
## Создание сайта в Quarto – Рендеринг {.smaller background-image="slides/slide.jpg" background-size="contain"}
...
![](slides/website-03-render.jpg)

## Создание сайта в Quarto – Публикация {.smaller background-image="slides/slide.jpg" background-size="contain"}
...
![Настройка отображения на GitHub Pages](slides/github-pages){#fig-github-pages height=11em}

# Рефлексия {background-image="slides/section.jpg" background-size="contain"}

## Рефлексия {.smaller background-image="slides/slide.jpg" background-size="contain"}
