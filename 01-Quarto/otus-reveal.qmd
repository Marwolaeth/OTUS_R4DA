...
::: {layout-ncol=2}
![](images/quarto){width=125 alt="Логотип Quarto" title="Логотип Quarto"}

![](images/posit2){width=125 alt="Логотип Posit"  title="Логотип Posit"}
:::
::::::
:::
...
::: {.notes}
Кстати, синтаксис Quarto работает на разных уровнях, в том числе внутри блоков кода. Для того, чтобы избегнуть исполнение этого кода, нужно заключить его в дополнительную пару фигурных скобок. Другой вариант – добавить команду {shortcodes=false} в опциях ячейки кода (в фигурных скобках).
...
::: {.notes}
Смотрим на нативную поддержку диаграмм (графов, флоучартов и т. д.). В Quarto, как я уже говорил можно взять и написать диаграмму на одном из джаваскриптовских плагинов mermaid и Graphviz. Здесь пример флоучарта, написанного на mermaid. Очень базовый пример, с базовым оформлением. Добавлено только одно определение класса, чтобы не было совсем скучно и вы увидели, что так можно делать.
:::
...
## Интерактивные элементы {.smaller .scrollable background-image="images/slide.jpg" background-size="contain"}
...
Содержание этого блока видно только в формате HTML
