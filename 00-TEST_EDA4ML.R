...
# 1. Проверка структуры данных (недостаток или избыток* информации, парные наблюдения).
# 2. Проверка качества данных (garbage in → garbage out):
#   а) правильный формат данных (Tidy Data);
#   б) правильный формат переменных;
#   в) пропущенные или бессмысленные значения;
#   г) выбросы и аномалии.
# 3. Определение общих статистических характеристик данных.
# 4. Выявление закономерностей и проверка собственных предположений.
# 5. Подготовка данных к дальнейшему анализу и принятию решений.

# Разведывательный анализ данных является важнейшим этапом в любом проекте по анализу данных, так как благодаря ему можно значительно снизить вероятность ошибок и повысить достоверность полученных результатов.

# * избытком информации может быть наличие данных для разных периодов (панельные данные) или наличие высоко коррелированных независимых переменных (мультиколлинеарность).
